...
This lab is based on profiling using GProf and GCov, and compiler optimizations, with no need of understanding VPR internal code base. See lab1handout for details and report to see the results that we found.
